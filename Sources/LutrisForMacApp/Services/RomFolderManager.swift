...
struct RomFolderConfig: Identifiable, Codable, Equatable {
    var id = UUID()
    var platform: String
    var path: String
}
...
@MainActor
final class RomFolderManager: ObservableObject {
    static let shared = RomFolderManager()

    @Published var folders: [RomFolderConfig] = []
    ...
    func addFolder(platform: String, path: String) {
    ...
    func scanROMs(progress: @escaping (Double) -> Void = { _ in }) -> [String: [URL]] {
    ...
    static var availablePlatforms: [String] {
