...
public struct Emulator: Identifiable, Codable {
    public let id: UUID
    public let name: String
    public let displayName: String
    public let category: Runner.RunnerCategory
    public let description: String
    public let supportsPlatforms: [String]
    public let installType: InstallType
    public let appName: String?
    public let brewName: String?
    public let bundleID: String?
    public let customInstallPath: String?

    public let githubOwner: String?
    public let githubRepo: String?

    public let directDownloadURL: String?
    public let downloadPageURL: String
    ...
    public enum InstallType: String, Codable, CaseIterable {
        case dmg
        case zip
        case tarGz
        case pkg
    ...
    public static let all: [Emulator] = [
        Emulator(
            name: "DOSBox",
            category: .retro,
