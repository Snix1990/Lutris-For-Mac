...
@MainActor
public final class RunnerManager: ObservableObject {
    public static let shared = RunnerManager()

    @Published public var runners: [Runner] = []
    @Published public var customRunners: [Runner] = []
    @Published public var gameRunnerConfigs: [UUID: [String: String]] = [:]
    ...
    public func addCustomRunner(name: String, binaryPath: String, category: Runner.RunnerCategory) {
        let runner = Runner(
            name: name,
            displayName: name,
            category: category,
    ...
    public func removeCustomRunner(_ runner: Runner) {
    ...
    @discardableResult
    public func launchGame(installPath: String, runnerName: String, runnerConfig: [String: String] = [:], environment: [String: String] = [:], captureOutput: Bool = true) async throws -> Int32? {
