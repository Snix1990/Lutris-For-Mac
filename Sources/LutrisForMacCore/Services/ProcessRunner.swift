...
public enum ProcessRunner {
    ...
    public static func writeOutputToLogFile(gameID: UUID, gameName: String, output: String) {
    ...
    public static func run(command: String, currentDirectory: URL?, environment: [String: String], captureOutput: Bool = true) async throws -> String {
    ...
    public static func parseEnvironmentVariables(from text: String) -> [String: String] {
