...
public final class SteamAPI {
    public static let shared = SteamAPI()
    ...
    public func detectSteamID() -> String? {
    ...
    public func detectAccountName(steamID: String) -> String? {
        let vdfPath = NSHomeDirectory() + "/Library/Application Support/Steam/config/loginusers.vdf"
        guard let content = try? String(contentsOfFile: vdfPath, encoding: .utf8) else { return nil }
    ...
    public func fetchOwnedGames(apiKey: String, steamID: String) async throws -> [SteamGameInfo] {
    ...
    public func fetchPlayerSummaries(apiKey: String, steamID: String) async throws -> SteamPlayerSummary? {
