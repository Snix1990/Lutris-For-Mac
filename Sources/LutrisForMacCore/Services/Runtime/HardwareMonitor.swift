...
public struct MemoryStats {
    ...
    public enum MemoryPressure { case normal, warning, critical }

    public init(totalGB: Double, usedGB: Double, freeGB: Double, wiredGB: Double, compressedGB: Double, pressure: MemoryPressure) {
...
public struct ThermalReading: Identifiable {
    public let id = UUID()
    public let name: String
    public let temperatureCelsius: Double?
    public let key: String

    public init(name: String, temperatureCelsius: Double?, key: String) {
        self.name = name
...
public struct FanReading: Identifiable {
    public let id = UUID()
    public let name: String
    public let rpm: Int
...
public struct DiskStats {
    ...
    public init(totalGB: Double, freeGB: Double, usedGB: Double) {
        self.totalGB = totalGB
        self.freeGB = freeGB
        self.usedGB = usedGB
    }
...
public final class FrameTimeTracker: ObservableObject {
    @Published public var fps: Double = 0
    @Published public var frameTimeMs: Double = 0
    @Published public var onePercentLowMs: Double = 0
    @Published public var zeroOnePercentLowMs: Double = 0
...
@MainActor
public final class HardwareMonitor: ObservableObject {
    public static let shared = HardwareMonitor()

    @Published public var memory: MemoryStats?
    @Published public var thermalReadings: [ThermalReading] = []
    @Published public var fanReadings: [FanReading] = []
    @Published public var disk: DiskStats?
    @Published public var thermalState: ProcessInfo.ThermalState = .nominal
    @Published public var smcAvailable = false

    public let frameTimeTracker = FrameTimeTracker()
    ...
    private func readFans() -> [FanReading] {
        ...
        for i in 0..<min(count, 5) {
            ...
            fans.append(FanReading(name: "Fan \(i)", rpm: rpm, minRPM: minVal, maxRPM: maxVal))
        }
        return fans
    }
...
public struct HardwareMonitorView: View {
