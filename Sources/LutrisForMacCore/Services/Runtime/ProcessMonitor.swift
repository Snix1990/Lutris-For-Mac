...
public struct MonitoredProcess: Identifiable, Equatable {
    public let id = UUID()
    ...
    public init(pid: Int32, name: String, command: String, startTime: Date, cpuPercent: Double, memoryMB: Double, parentPID: Int32) {
        self.pid = pid
        self.name = name
...
public struct LogEntry: Identifiable {
    ...
    public enum Stream { case stdout, stderr, system }

    public init(timestamp: Date, text: String, stream: Stream) {
...
public final class ProcessMonitor: ObservableObject {
    ...
    @Published public var rootPID: Int32?
    @Published public var processes: [MonitoredProcess] = []
    @Published public var exit: ProcessExit = .running
    @Published public var log: [LogEntry] = []
    @Published public var totalCPU: Double = 0
    @Published public var totalMemoryMB: Double = 0

    // MARK: Configuration
    public var maxLogEntries = 5000
    public var pollInterval: TimeInterval = 2.0
    public var statsInterval: TimeInterval = 3.0
    ...
    public func launch(exePath: String, arguments: [String] = [], environment: [String: String] = [:]) async throws {
        stop()
    ...
    public func attach(pid: Int32) async {
        stop()
        rootPID = pid
        self.isRunning = true
        self.exit = .running
...
public struct ProcessMonitorView: View {
