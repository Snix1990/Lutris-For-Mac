...
@MainActor
public final class CrossOverTricksManager: ObservableObject {
    public static let shared = CrossOverTricksManager()

    public static let scriptURL = URL(string: "https://media.codeweavers.com/pub/crossover/crossvertricks/crossovertricks")!
    ...
    @Published public var installedComponents: Set<String> = []
    ...
    public static let knownComponents: [(id: String, name: String, description: String)] = [
    ...
    public func run(components: [String], bottleName: String) -> AsyncStream<String> {
