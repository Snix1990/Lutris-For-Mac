...
@MainActor
public final class OSDManager: ObservableObject {
    public static let shared = OSDManager()

    @Published public var settings: OSDSettings {
        didSet { save() }
    }
    ...
    @Published public var ramUsage: Double = 0
    @Published public var cpuUsage: Double = 0
    @Published public var frameTime: Double = 16
    @Published public var mediaTitle: String = ""
    @Published public var loggingActive = false

    // Runtime idle tracking
    public var lastInteraction = Date.distantFuture
    ...
    public var isIdleCheckNeeded = false
    ...
    public func show() {
        ...
        // TODO: moved to Core – OSDOverlayView lives in App; inject via closure or move view
    ...
    private func showLockPanel() {
        ...
        _ = makeButtonPanel()
        // TODO: moved to Core – LockButtonView lives in App
    ...
    private func showMediaPanel() {
        ...
        // TODO: moved to Core – MediaButtonsView lives in App
    ...
    public func requestInteraction() {
        show()
    ...
    public func resizeToFit() {
        guard let panel = overlayPanel,
              // TODO: moved to Core – OSDOverlayView lives in App
              let hosting = panel.contentView as? NSHostingView<AnyView> else { return }
        hosting.layout()
        panel.setContentSize(hosting.fittingSize)
        positionPanel(panel)
        repositionButtonPanels()
    ...
    public func sendMediaCommand(_ cmd: MediaCommand) {
        let keyCode: UInt32
        switch cmd {
        case .play, .togglePlayPause: keyCode = 16
        case .nextTrack:              keyCode = 17
        case .previousTrack:          keyCode = 18
    ...
    public static func installCarbonHandler() {
    ...
    public func sampleAll() {
        let pm = PerformanceMonitor.shared
        fps = pm.fps
        frameTime = pm.frameTime
        // TODO: moved to Core – always sample CPU/RAM
        ramUsage = sampleRAM()
        cpuUsage = sampleCPU()
