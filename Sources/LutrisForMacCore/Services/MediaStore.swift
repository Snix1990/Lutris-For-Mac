...
public final class MediaStore: ObservableObject {
    ...
    public func hasMedia(gameID: String, type: MediaType) -> Bool {
        index[gameID]?[type] != nil
    }

    public func mediaExtension(gameID: String, type: MediaType) -> String? {
        index[gameID]?[type]
    }
    ...
    public func cachedImage(for gameID: String, type: MediaType) -> NSImage? {
    ...
    public func loadImage(from urlString: String, gameID: String, type: MediaType) async -> NSImage? {
    ...
    public func setLocalImage(at sourceURL: URL, gameID: String, type: MediaType) -> NSImage? {
    ...
    public func removeMedia(for gameID: String, type: MediaType) {
    ...
    public func removeAllMedia(for gameID: String) {
        for type in MediaType.allCases {
